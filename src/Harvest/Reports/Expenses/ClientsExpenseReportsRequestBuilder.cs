...
/// </summary>
public class ClientsExpenseReportsRequestBuilder
{
    /// <summary>
    ...
    public ClientsExpenseReportsRequestBuilder(Dictionary<string, object> pathParameters,
        HarvestRequestAdapter requestAdapter)
    {
        _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
        _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));

        this.UrlTemplate = "{+baseurl}/reports/expenses/clients{?from,to,page,per_page}";
    ...
    public async Task<ExpenseReportsResponse<ClientExpenseReport>> GetAsync(
        Action<ClientsExpenseReportsRequestBuilderGetRequestConfiguration> requestConfiguration = default,
        CancellationToken cancellationToken = default)
    {
        RequestInformation requestInfo = this.ToGetRequestInformation(requestConfiguration);
        return await this.RequestAdapter.SendAsync<ExpenseReportsResponse<ClientExpenseReport>>(requestInfo,
            cancellationToken);
    }

    /// <summary>
    /// Builds the request to retrieve a list of clients expense reports.
    /// </summary>
    /// <param name="requestConfiguration">The configuration for the request such as headers.</param>
        ...
        Action<ClientsExpenseReportsRequestBuilderGetRequestConfiguration> requestConfiguration = default)
    {
        ...
        var requestConfig = new ClientsExpenseReportsRequestBuilderGetRequestConfiguration();
    ...
    /// </summary>
    public class ClientsExpenseReportsRequestBuilderGetRequestConfiguration : RequestConfiguration
    {
        /// <summary>
        /// Gets or sets the query parameters for the request.
        /// </summary>
        public ClientsExpenseReportsRequestBuilderGetQueryParameters QueryParameters { get; set; } = new();
    }

    /// <summary>
    /// Defines the query parameters for the request to retrieve a list of clients expense reports.
    /// </summary>
    public class ClientsExpenseReportsRequestBuilderGetQueryParameters : ExpenseReportsQueryParameters
    {
    }
}