...
/// <summary>
/// Defines the detail for creating a task assignment for a project.
/// </summary>
public class CreateTaskAssignment
{
    /// <summary>
    /// Gets or sets the ID of the task to associate with the project.
    /// </summary>
